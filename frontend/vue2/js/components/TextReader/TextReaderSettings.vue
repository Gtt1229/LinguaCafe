<template>
    <v-dialog v-model="value" persistent scrollable max-width="1000">
        <v-card id="text-reader-settings" outlined class="rounded-lg">
            <v-card-title>
            ...
            <v-card-text class="pb-12" v-if="settingsLoaded" style="height: 800px">
                ...
                <v-tabs-items v-model="tab" elevation="0" class="rounded-lg mt-4 pa-6">
                    ...
                    <v-tab-item :value="0">
                            ...
                            >
                                ...
                                >
                                    <template v-slot:thumb-label>{{
                                        maximumTextWidthData[settings.maximumTextWidth]
                                    }}</template>
                                </v-slider>
                            </v-col>
                        </v-row>
                        ...
                        <div
                            class="subheader subheader-margin-top d-flex mb-2"
                            v-if="textToSpeechVoices.length"
                        >
                            Text to speech
                        </div>
        ...
        saveSettings(settingName = '') {
            ...
            if (this.textToSpeechSelectedVoice !== null) {
                localStorage.setItem(
                    `${this.$props.language}-text-to-speech-voice`,
                    JSON.stringify(this.textToSpeechSelectedVoice)
                )
            }
