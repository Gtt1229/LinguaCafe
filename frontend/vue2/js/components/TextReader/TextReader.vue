<template>
    ...
    >
        ...
        <div
            id="reader-box"
            :style="{ 'max-width': maximumTextWidthData[settings.maximumTextWidth] }"
            v-if="chapterId !== null"
        >
            <div id="toolbar-box">
                <div
                ...
                >
                    ...
                    >
                    <v-btn title="Chapters" icon @click="openDialog('chapters')"
                        ><v-icon>mdi-book-alphabet</v-icon></v-btn
                    >
                    <v-btn title="Glossary" icon @click="openDialog('glossary')"
                        ><v-icon>mdi-translate</v-icon></v-btn
                    >
                    <v-btn title="Increase font size" icon @click="increaseFontSize"
                        ><v-icon>mdi-magnify-plus</v-icon></v-btn
                    >
                    <v-btn title="Decrease font size" icon @click="decreaseFontSize"
            ...
            >
                ...
                >
                    ...
                    >
                        <v-spacer></v-spacer>
                        <v-btn rounded color="primary" @click="finish()"
                            ><v-icon>mdi-text-box-check</v-icon> Finish reading</v-btn
                        >
                    </div>
                </v-card-text> </v-card
            >&nbsp;
            ...
            >
                <!-- Title -->
                <v-card-title v-if="!saving && !finishError"
                ...
                <v-card-text v-if="!saving && finishError" height="300px">
                    <v-alert class="my-3" border="left" type="error" v-if="finishError">
...
import {
    DefaultLocalStorageManager,
    defaultSettings,
} from './../../services/LocalStorageManagerService'
...
export default {
    ...
    methods: {
        ...
        toolbarSettingChanged() {
            ...
            this.$refs.textReaderSettings.changeSetting(
                'plainTextMode',
                this.settings.plainTextMode,
                true
            )
        },
        openDialog(dialog) {
